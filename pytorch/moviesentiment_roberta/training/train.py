...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Train a RoBERTa movie sentiment classifier")
    parser.add_argument('--eval', type=float, default=0.0, help='Proportion of dataset to set aside for evaluation')
